...
```bash
sudo apt install --assume-yes "apt-transport-https" "bat" "build-essential" "ca-certificates" "curl" "file" "fish" "git" "gnupg" "hyperfine" "podman" "postgresql-client" "procps" "tmux" "unzip" "wget" "zip"
```
...
Além desse [`README.md`](README.md), esse repositório possui recursos e _scripts_.
...
Pode ser necessário remover manualmente o diretório `SoftwareDistribution` usando o Windows File Explorer.
